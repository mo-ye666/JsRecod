    ...
    return [
      {
        ...
        properties: [
          ...
          {
            label: '选中值',
            mapping: 'props.true-label',
            type: 'input',
            value: '',
            help: '选中时的值'
          }, {
            label: '未选中值',
            mapping: 'props.false-label',
            type: 'input',
            value: '',
            help: '没有选中时的值'
          },
...
context.components['checkbox-group'] = {
  // 组件默认配置
  getConfig(parent, ctx) {
    return {
      uuid: '',
      ...
      },
      {
        ...
        properties: [
          ...
          },
          {
            ...
            value: '',
            vif(meta) { return meta.design.buttonStyle },
            help: '按钮形式的 chekbox 激活时的填充色和边框色'
          },
          baseProps.common.classList(),
         ... baseProps.common.vif(),
          baseProps.common.disabled()
